...
describe('upload reduce', () => {
    ...
    it('should set status to ERROR and error to action.payload on UPLOAD_FILE_ERROR', () => {
        expect(reducer({ state: 'value' }, uploadError(new Error('boom')))).toEqual({
            state: 'value',
            status: 'ERROR',
            error: 'boom',
        });
    ...
    it('should handle openUpload', () => {
        expect(reducer({ state: 'value' }, openUpload()))
            .toEqual({
                state: 'value',
                open: true,
            });
    ...
    it('should handle closeUpload', () => {
        expect(reducer({ state: 'value' }, closeUpload()))
            .toEqual({
                state: 'value',
                open: false,
            });
