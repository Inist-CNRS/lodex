...
export const CHANGE_CONTRIBUTED_RESOURCE_FILTER = 'CHANGE_CONTRIBUTED_RESOURCE_FILTER';
...
export const changeContributedResourceFilter = createAction(CHANGE_CONTRIBUTED_RESOURCE_FILTER);
