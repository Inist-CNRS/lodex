...
import { isSubresourceFieldTransformation } from './TabValueSubresourceField';
...
export const TabValueColumnComponent = ({
    column,
    handleChange,
    handleSelect,
    p: polyglot,
...
TabValueColumnComponent.propTypes = {
...
TabValueColumnComponent.defaultProps = {
    column: '',
};
