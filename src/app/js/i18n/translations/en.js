...
export default {
    ...
    error_transformers_required_or_composed_of_required: 'transformers required (except if composedOf is set)',
    ...
    error_composedOf_required_or_transformers_required: 'composedOf required (except if there is transformers)',
