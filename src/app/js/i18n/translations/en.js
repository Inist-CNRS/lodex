...
export default {
    ...
    'error_transformer.operation_invalid': 'Operation operation %{operation} does not exists',
    'error_transformer.args_invalid': 'Operation operation %{operation} is invalid : it requires %{args} args',
