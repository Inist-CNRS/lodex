    ...
    describe('updateCharacteristics', () => {
        ...
        describe('When name received and updatedField is a composed field with value fields', () => {
            ...
            const ctx = {
                ...
                field: {
                    findByNames: jest.fn().mockImplementation((names: any) => {
                        const fields = {};

                        if (names.includes('updateField')) {
                            // @ts-expect-error TS(2339): Property 'updatedField' does not exist on type '{}... Remove this comment to see the full error message
                            fields.updatedField = {
                                _id: 'id',
                                name: 'updatedField',
                                transformers: [
                        ...
                        if (names.includes('bar')) {
                            // @ts-expect-error TS(2339): Property 'bar' does not exist on type '{}'.
                            fields.bar = {
                                _id: 'id',
                                name: 'bar',
                                transformers: [
