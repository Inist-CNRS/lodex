...
describe.only('exportExtendedNquads', () => {
    ...
    before(() => {
        ...
        s.onCall(4).yields(null, { statusCode: 200 }, apiPalResponse);
        s.onCall(5).yields(null, { statusCode: 200 }, apiCatResponse[0]);
        s.onCall(6).yields(null, { statusCode: 200 }, apiCatResponse[1]);
    });
