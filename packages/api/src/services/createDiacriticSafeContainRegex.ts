...
export function createDiacriticSafeContainRegex(value: any) {
    ...
    const normalizedValueWithComposedCharactersReplaced = Object.entries(
        ...
        (newValue: any, [letter, composed]) =>
            newValue.replaceAll(letter, composed),
        normalizedValue,
    );
    ...
    const valueWithSingleCharactersDiacriticsReplaced = Object.entries(
        ...
        (newValue: any, [letter, diacritics]) =>
    ...
    const diacriticsSafeRegex = Object.entries(multipleCharsMappings).reduce(
        (newValue: any, [letters, diacritics]) =>
            newValue.replaceAll(
                new RegExp(
