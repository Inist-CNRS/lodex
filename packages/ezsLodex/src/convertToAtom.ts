 ...
 * @returns {String}
 */
export default function convertToAtom(this: any, data: any, feed: any) {
    ...
    const title = fields.find((f: any) => f.overview && f.overview === 1);
    const description = fields.find((f: any) => f.overview && f.overview === 2);
