...
describe('convertToAtom', () => {
    ...
    it('should return the correct feed from empty data', (done: any) => {
        from([{}])
    ...
    it('should return the correct feed from one resource', (done: any) => {
        from([
            {
                uri: 'http://uri',
                title: 'Title',
    ...
    it('should return the correct feed from two resources', (done: any) => {
        from([
            {
                uri: 'http://uri/1',
                title: 'Title',
